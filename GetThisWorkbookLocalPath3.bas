Attribute VB_Name = "GetThisWorkbookLocalPath3"
Option Explicit
...
'Check "Microsoft Forms 2.0 Object Library" In the References dialog box.
'-------------------------------------------------------------------------------
...
Public Function GetThisWorkbookLocalPath3() As String
    ...
    wScript = "PowerShell.exe -NoLogo -WindowStyle Hidden -Command """ & _
              ...
              "[System.Windows.Forms.SendKeys]::SendWait('{ESC}{ESC}%');" & _
              "Start-Sleep -Milliseconds 200;" & _
              "[System.Windows.Forms.SendKeys]::SendWait('FIL{ESC}')"""

    Dim wShell As Object, wExec As Object
    Set wShell = CreateObject("Wscript.shell")
    Set wExec = wShell.Exec(wScript)
    ...
    Do While wExec.Status = 0
        ...
        If Timer - t1 >= 10 Then
            wExec.Terminate
            Debug.Print Time, "PowerShell terminated due to time over."
            Exit Function
        End If
    Loop
