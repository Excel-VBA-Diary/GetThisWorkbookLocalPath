Attribute VB_Name = "GetThisWorkbookLocalPath2"
Option Explicit
...
Public Function GetThisWorkbookLocalPath2() As String
    ...
    If CreateObject("Scripting.FileSystemObject").FileExists(strPath & "\" & ThisWorkbook.Name) Then
...
'-------------------------------------------------------------------------------
Public Function DecodeURL_ASCII(ByVal URL As String) As String
    If URL = "" Then Exit Function
